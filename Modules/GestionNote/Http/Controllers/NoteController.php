        ...
        $evaluations = $request->classe ?  $ev->map(
            function ($value) use ($section_id) {
                ...
                return [
                    'id' => $value->id,
                    'code' => $code,
                    'notation_evaluation' => $value->notation,
                    'niveau_matiere_id' => $value->enseignement_annee->niveau_matiere_id,
                    'filiere_niveau_matiere_ue_id' => $value->enseignement_annee->filiere_niveau_matiere_ue_id,
                    'notation_niveau_matiere' => $notation_niveau_matiere
                ];
            }
        ) : [];
        $eleves = collect();
