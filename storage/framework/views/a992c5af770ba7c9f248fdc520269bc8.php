    ...
    <div>
       ...
       <!-- <img style="max-width:50%; height:auto" src="logos/iat-logo.png" alt="Logo de l'entreprise"> -->
        ...
        <b><i style="font-size: 13px; margin: 5px;">ANNEE SCOLAIRE : 2023-2024</i>&nbsp;&nbsp;</b><br>
                    ...
                    <b><i style="font-size: 13px; margin: 5px;">SECTION : <?php if($section == '1'): ?> Primaire <?php elseif($section == '2' and $donnee['bulletin']->classe_annee->classe->niveau->id <= 10): ?> Collège <?php else: ?> Lycée <?php endif; ?></i>&nbsp;&nbsp;</b><br>
                ...
                <div style="text-align: right; border-bottom:0; border-right: 0; border-top:0" class="50p">
                    ...
                    <b><i style="font-size: 13px; margin: 5px;">SEMESTRE : I</i>&nbsp;&nbsp;</b><br>
                    <b><i style="font-size: 13px; margin: 5px;">SECTION : <?php if($section == '1'): ?> Primaire <?php elseif($section == '2' and $donnee['bulletin']->classe_annee->classe->niveau->id <= 10): ?> Collège <?php else: ?> Lycée <?php endif; ?></i>&nbsp;&nbsp;</b><br>
                    <b><i style="font-size: 13px; margin: 5px;">NIVEAU : <?php echo e($donnee['bulletin']->classe_annee->classe->niveau->code); ?></i>&nbsp;&nbsp;</b><br>
                    <b><i style="font-size: 13px; margin: 5px;">Rédouble : <span style="color:green">Jamais Rédoublé</span></i>&nbsp;&nbsp;</b><br>
                </div>
        ...
        <div style="margin-left: 260px; width: 210px; height: 30px; margin-top: 10px;">
            <b style="font-size: 20px;">Classe de : <?php echo e($donnee['bulletin']->nom_classe); ?></b> 
        </div>
        ...
        <div style="margin-top: 10px; position:absolute">
            ...
            <b style="font-size: 13px;">Nom et Prénom de l'élève : <?php echo e($donnee['bulletin']->nom_prenom_apprenant); ?></b> <br>
        ...
        <div style="margin-top: 10px; margin-left: 400px; position:absolute">
            <b style="font-size: 13px;">Matricule : <?php echo e($donnee['bulletin']->matricule_apprenant); ?></b> <br>
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $donnee['detail']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><b><?php echo e($line->nom_matiere); ?></b></td>
                        ...
                        <td style="text-align:center;" width="35"><?php echo e($line->rang); ?></td>
                ...
                <tr>
                    ...
                    <td style="text-align:center" colspan="8"><?php echo e($donnee['bulletin']->moyenne_details_notes); ?></td>
                </tr>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH C:\Users\MAHAMADOU\OneDrive\Documents\projet_synetcom\system_1\school\school-system\resources\views\secondaire\bulletin_par_classe.blade.php ENDPATH**/ ?>