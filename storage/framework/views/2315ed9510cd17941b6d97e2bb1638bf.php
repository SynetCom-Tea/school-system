...
<body>
    ...
    <div class="main-content">
        ...
        <div class="titre">BULLETIN DE NOTES DU <?php echo e(strtoupper($bulletin->periode)); ?></div>

        <!-- INFOS ELEVE -->
        <table>
            <tr style="font-size: 14px;">
                <td colspan="2"><b>Nom et Prénoms: <?php echo e($bulletin->nom_prenom_apprenant); ?></b> <br>
                    <b>Matricule</b> : <?php echo e($bulletin->matricule_apprenant); ?>

                </td>
                <td><b>Année</b> : <?php echo e($bulletin->annee_scolaire); ?> <br>
                    <b>Classe</b> : <?php echo e($bulletin->nom_classe); ?> <br>
                    <b>Effectif</b> : <?php echo e($bulletin->classe_effectif); ?> <br>
                    <b>Date</b> : <?php echo e($bulletin->created_at->format('d-m-Y')); ?>
        ...
        <table>
            ...
            <tr>
                <td style="height: 60px; width: 33%;">
                    <b>MOYENNE</b><br>
                    <span style="margin-left: 10px;">En chiffre : <b><?php echo e($bulletin->moyenne_details_notes); ?></b><br></span>
                    <span style="margin-left: 10px;">En lettre: <b><?php echo e(moyenneEnLettre($bulletin->moyenne_details_notes)); ?></b></span>
                    <br><br>
                    <b>RANG : <?php echo e($bulletin->rang); ?></b><br><br>
                </td>
                <td style="height: 60px; width: 34%;">
                    Plus forte moyenne : <b><?php echo e($bulletin->classe_forte_moyenne); ?><br></b>
                    Plus faible moyenne : <b><?php echo e($bulletin->classe_faible_moyenne); ?><br></b>
                    Moyenne classe : <b><?php echo e($bulletin->classe_moyenne); ?><br><br></b>
                </td>
            ...
            <tr>
                <td style="width: 33%;">
                    Moyenne matières littéraires : <b><?php echo e($bulletin->moyenne_litteraire); ?></b>
                </td>
                <td style="width: 34%;">

                    Moyenne matières scientifiques : <b><?php echo e($bulletin->moyenne_scientifique); ?></b>
                </td>
                <td style="width: 33%;  vertical-align: top;">
                    Moyenne autres matières : <b><?php echo e($bulletin->moyenne_autres_matieres); ?></b>
                </td>
            </tr>
        </table>
        ...
        <?php if($bulletin->moyenne_annuelle !== null): ?>
        ...
        <table>
            ...
            <tr>
                ...
                <th>Moy</th>
                <th>Rang</th>
                <th rowspan="2"><?php echo e($bulletin->plus_faible_moyenne_annuelle); ?></th>
                <th rowspan="2"><?php echo e($bulletin->plus_forte_moyenne_annuelle); ?></th>
                
            </tr>
            <tr class="center">
                <td><?php echo e($moyenneSemestre1); ?></td>
                <td><?php echo e($rangSemestre1); ?></td>
                <td><?php echo e($moyenneSemestre2); ?></td>
                <td><?php echo e($rangSemestre2); ?></td>
                <td><b><?php echo e($bulletin->moyenne_annuelle); ?></b></td>
                <td><b><?php echo e($bulletin->rang_annuel); ?></b></td>
                
            </tr>

            <tr>
                <td colspan="8" class="center">
                    <b><?php echo e(strtoupper(moyenneEnLettre($bulletin->moyenne_annuelle))); ?></b>
                </td>
            </tr>
        </table>
        <br>
...
<?php /**PATH C:\Users\SYNETCOM\Desktop\projects\school-system\resources\views/secondaire/bulletin.blade.php ENDPATH**/ ?>