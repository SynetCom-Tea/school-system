...
<body>
    ...
    <div>
        <div style="position:absolute; margin-top:10px;">
            ...
            <b><i style="font-size: 13px; margin: 5px;">FILIERE : <?php echo e($bulletin->nom_classe); ?> </i>&nbsp;&nbsp;</b><br>
        ...
        <?php if($section == '1' || $section == '2'): ?>
            <b><i style="font-size: 13px; margin: 5px;">ANNEE SCOLAIRE : <?php echo e($bulletin->classe_annee->annee->libelle); ?></i>&nbsp;&nbsp;</b><br>
    ...
    <b style="font-size: 13px;">Matricule :</b> <?php echo e($bulletin->matricule_apprenant); ?> <br>
    ...
    <div style="margin-top: 10px; margin-left: 400px; position:absolute">
        <!-- <b style="font-size: 13px;">Prof responsable de la classe : <span style="color:green">NON DEFINI</span></b> <br> -->
        <b style="font-size: 13px;">Nom et Prénom de l'étudiant :</b> <?php echo e($bulletin->nom_prenom_apprenant); ?> <br>

        <!-- <b style="font-size: 13px;">Rang : <?php echo e($bulletin->rang); ?>e</b> -->
    </div>
    ...
    <tbody>
        ...
        <!-- les données -->
        <?php $__currentLoopData = $bulletin->groupUe; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nom => $ue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <!-- <td>101</td> -->
...
<?php /**PATH C:\Users\MAHAMADOU\OneDrive\Documents\projet_synetcom\system_1\school\school-system\resources\views\superieur\bulletin.blade.php ENDPATH**/ ?>