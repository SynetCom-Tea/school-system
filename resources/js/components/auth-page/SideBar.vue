...
<div style="height: 100%">
    <v-app-bar color="rgb(0, 73, 128)" prominent>
        <div class="app-bar-content">
            ...
            <div class="text-end">
                <v-btn @click="redirectToWebsite" class="text-none" style="color: rgb(125, 0, 44); background-color: white" rounded variant="flat" width="90">
                    Site web
                </v-btn>
            </div>
        ...
        <div id="sidebar">
            ...
            <div class="sidebar-body">
                <div class="sidebar-profile">
                    <img :src="'../assets/' + profileInfo.photo.file" :alt="profileInfo.photo.title" />
                ...
                <div class="sidebar-links">
                    ...
                    <div class="links">
                        <v-list density="compact" v-model:opened="open">
                            <v-list-item class="list-case" v-for="link in getListMenus[0]" :key="link.title">
                            ...
                            <v-list-group :value="getListMenus[4].title">
                                <template v-slot:activator="{ props }">
                                    <v-list-item class="group-title" v-bind="props">
                                        <template v-slot:prepend>
                                            <v-icon :title="getListMenus[4].title" :icon="getListMenus[4].icon"></v-icon>
                                        </template>
                                        <v-list-item-title class="text-wrap" v-text="getListMenus[4].title"></v-list-item-title>
                                    </v-list-item>
                                </template>

                                <v-list-item class="sub-list-group" v-for="(item, i) in getListMenus[4].children" :key="i" @click="page(item.link)">
                                    <template v-slot:prepend>
                            ...
                            <v-list-group :value="getListMenus[1].title">
                                <template v-slot:activator="{ props }">
                                    <v-list-item class="group-title" v-bind="props">
                                        <template v-slot:prepend>
                                            <v-icon :title="getListMenus[1].title" :icon="getListMenus[1].icon"></v-icon>
                                        </template>
                                        <v-list-item-title class="text-wrap" v-text="getListMenus[1].title"></v-list-item-title>
                                    </v-list-item>
                                </template>

                                <v-list-item class="sub-list-group" v-for="(item, i) in getListMenus[1].children" :key="i">
                                    <template v-slot:prepend>
                                        <v-icon :title="item.title" :icon="item.icon"></v-icon>
                                    </template>
                            ...
                            <v-list-group :value="getListMenus[5].title">
                                <template v-slot:activator="{ props }">
                                    <v-list-item class="group-title" v-bind="props">
                                        <template v-slot:prepend>
                                            <v-icon :title="getListMenus[5].title" :icon="getListMenus[5].icon"></v-icon>
                                        </template>
                                        <v-list-item-title class="text-wrap" v-text="getListMenus[5].title"></v-list-item-title>
                                    </v-list-item>
                                </template>

                                <v-list-item class="sub-list-group" v-for="(item, i) in getListMenus[5].children" :key="i" @click="page(item.link)">
                                    <template v-slot:prepend>
                                        <v-icon :title="item.title" :icon="item.icon"></v-icon>
                                    </template>
