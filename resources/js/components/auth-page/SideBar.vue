        ...
        <div id="sidebar">
            ...
            <div class="sidebar-body">
                <div class="sidebar-profile">
                    <img :src="'/assets/' + getProfile.photo.file" :alt="getProfile.photo.title" />
                    <v-slide-x-transition mode="in-out" leave-absolute>
                        <v-list-item id="profile-name" lines="two" :title="getProfile.name" :subtitle="getProfile.typeUser">
                        </v-list-item>
                    ...
                    <div class="links">
                        <v-list density="compact" v-model:opened="open">
                            ...
                            <v-list-group :value="getListMenus[1].title">
                                ...
                                <v-list-item class="sub-list-group" v-for="(item, i) in getListMenus[1].children" :key="i" @click="page(item.link)">
                                    <template v-slot:prepend>
                                        <v-icon :title="item.title" :icon="item.icon"></v-icon>
                                    </template>
                            ...
                            <v-list-group :value="MenuAdmin.title" v-if="$page.props.roles == 'Administrateur'">
                                <template v-slot:activator="{ props }">
                                    <v-list-item class="group-title" v-bind="props">
                                        ...
                                        <v-list-item-title class="text-wrap" v-text="MenuAdmin.title"></v-list-item-title>
                                    </v-list-item>
                                </template>

                                <v-list-item class="sub-list-group" v-for="(item, i) in MenuAdmin.children" :key="i" @click="page(item.link)">
                                    <template v-slot:prepend>
                                        <v-icon :title="item.title" :icon="item.icon"></v-icon>
                                    </template>
...
export default {
    ...
    mounted() {
        ...
        const sections = [{
                title: 'Primaire',
                icon: mdiSchool,
                link: '/enseignement/configuration/1'
            },
            {
                title: 'Secondaire',
                icon: mdiSchool,
                link: '/enseignement/configuration/2'
            },
            {
                title: 'Supérieur',
                icon: mdiSchool,
                link: '/enseignement/configuration/3'
            },
            {
                title: 'Universitaire',
                icon: mdiSchool,
                link: '/enseignement/configuration/4'
            },
        ];
