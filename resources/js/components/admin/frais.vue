  ...
  <form @submit.prevent="submitForm" novalidate>
    <v-container fluid>
      <v-card variant="outlined" style="border: 2px solid #7d002c">
        <v-card-title style="color: white; background-color: #7d002c">FRAIS</v-card-title>
        <v-divider></v-divider>
        <br />
        ...
        <v-card v-if="!importation">
          <v-card-text>
            <v-row disabled :key="frais.id" v-for="(frais, i) in form.frais">
              <v-col cols="3" v-if="type == '3' || type == '4'">
                <Autocomplete
                  :items="tabsFilieres"
              ...
              <v-col cols="3">
                <TextField
                  label="Libelle frais"
                  :isRequired="true"
                  placeholder="Libelle frais"
                  required
                  v-model="frais.libelle"
                ></TextField>
              </v-col>
              <v-col cols="3">
                <TextField
              ...
              <v-col cols="2">
                ...
                <v-tooltip v-model="tooltipModel" v-if="form.frais.length <= 1" bottom>
                  ...
                  <div style="width: 200px">
                    Ce bouton reste inactif.Vous ne pouvez supprimer que s'il y'a au moins
                    2 lignes.
                  </div>
                </v-tooltip>
                <Button
