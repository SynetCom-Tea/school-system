                        ...
                        <v-card-text>
                            ...
                            <v-row disabled :key="matiere.id" v-for="(matiere, i) in form.matieres">
                                ...
                                <v-col md="2">
                                    ...
                                    <TextField label="Coeff" class="mt-2" :isRequired="true" placeholder="Coeff" required v-model="matiere.coefficient" @update:modelValue="submitForm(matiere)"></TextField>
                                </v-col>
                                <v-col md="2">

                                    <TextField label="VH" class="mt-2" placeholder="VH" required v-model="matiere.volume_horaire" @update:modelValue="submitForm(matiere)"></TextField>
                                </v-col>
                                <v-col md="1">
                                    <br>
                                    <Button
    ...
    methods: {
        ...
        async isValid() {
            ...
            if(this.importation && this.form.fichier_matiere != null){
                fichier = true
            }else if(!this.importation && !this.form.matieres.find(el => this.form.niveau == null || this.form.niveau == '' || this.form.matiere == '' || el.matiere == null || el.matiere == '' || el.coefficient == 0 || el.coefficient == null || el.coefficient.trim() == '')){
                fichier = true
            }
            if(fichier){
                valid = true
