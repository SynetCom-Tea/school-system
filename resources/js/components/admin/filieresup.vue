        ...
        <v-container fluid>
            ...
            <v-card>
                <v-card-text>
                    ...
                    <v-row>
                        <v-col>
                            <v-switch label="Souhaiterez-vous importez le fichier des filieres ?" v-model="importation" @update:modelValue="submitForm(null)" color="info" inset></v-switch>
                        </v-col>
                 ...
                 <v-card-text v-if="!importation" >
                    ...
                    <v-row disabled :key="filiere.id" v-for="(filiere, i) in form.filieres">
                        <v-col md="4">
                            ...
                            <TextField label="Code filiere" placeholder="Code filiere" class="mt-2" :isRequired="true" v-model="filiere.code" @update:modelValue="submitForm(filiere)">
                            </TextField>
                        </v-col>
                        <v-col md="4">

                            <TextField label="Nom de la filiere" class="mt-2" :isRequired="true" placeholder="Nom de la filiere" required v-model="filiere.libelle" @update:modelValue="submitForm(filiere)">
                            </TextField>
                        </v-col>
                        <v-col md="2" >
                            <br>
    ...
    donneesManquantes(tableau) {
      ...
      return -1; // Retourne -1 si toutes les données sont présentes
        ...
        async submitForm(element) {
            ...
            this.$emit("filiereSupFormValid", this.isValid());
        },
        async isValid() {
            let fichier = false
            let valid = false
