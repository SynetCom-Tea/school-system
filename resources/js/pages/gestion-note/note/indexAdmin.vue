...
<template>
    ...
    <div style="margin: 20px">
        <Button variant="flat" style="height: 30px; text-transform: none; box-shadow: 10px 5px 5px #7d002c" class="add-button-style"  nameButton="Ajouter" title="Attribution des notes" small color="primary"  :prependIcon="icon.mdiPlus" @click="create"  v-permission:any="'manage_school|note.create'">
        </Button>
    </div>
