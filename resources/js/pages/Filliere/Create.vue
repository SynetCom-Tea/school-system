...
export default {
    ...
    methods: {
        ...
        goBack() {
            router.get(route('filieres.index', this.section_id))
        },
        addRow() {
...
<v-card variant="outlined" style="border: 2px solid #7d002c">
    ...
    <v-card-title style="color: white; background-color: #7d002c"
            >Ajouter des filières</v-card-title
          >
          <v-divider></v-divider>
        <br>
...
<v-alert
          ...
          >
            <li>
              Cette section vous permet de renseigner les filières enseignées dans cet
              établissement
            </li>
            <li>
          ...
          <v-row>
            <v-col>
              <v-switch
                ...
                color="#004980"
                inset
                :label="'Importation d\'un fichier pour alimenter les filières'"
              ></v-switch>
            </v-col>
                    ...
                    <v-card-text>
                        <v-row :key="donnee.id" v-for="(donnee, i) in form.donnees">
                                    ...
                                    <v-row>
                                        ...
                                        <v-col md="2">
                                            <v-btn title="supprimer la filière" variant="outlined" :disabled="!(form.donnees.length > 1)" icon @click="removeRow(donnee)" fab small color="error">
                        ...
                        <v-row>
                                        <v-col offset-md="11" cols="4">
                                            <v-btn title="ajouter une filière" variant="outlined" icon @click="addRow()" fab small color="primary">
