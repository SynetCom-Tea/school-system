...
<template>
<v-card>
    <page-toolbar :icon="icon.mdiAccountSchool" >Gestion des filières</page-toolbar>
    <v-card-text>
            ...
            <template v-slot:default="{ isActive }">
                <v-card>
                    <v-toolbar dense color="orange" dark>
                        <v-toolbar-title>
                            <v-icon left :icon="icon.mdiPencil"></v-icon> Modifier la filière {{ editdata.code }}
                        </v-toolbar-title>
                        <v-spacer></v-spacer>
                    </v-toolbar>
                    <v-card-text>
                        <v-form>
                            ...
                            <v-row>
                                <v-col cols="12" md="12">
                                    <text-field name="name" label="Libelle" placeholder="Libelle" v-model="form.name"></text-field>
                                </v-col>
                            </v-row>
                            <v-row>
                                <select-field label="Cycles" item-title="name" item-value="id" :items="cycles" v-model="form.cycle_id">
                                </select-field>
                            </v-row>
                        </v-form>
                    </v-card-text>
