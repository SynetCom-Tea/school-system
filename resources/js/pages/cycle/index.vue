...
<template>
<v-card>
    <page-toolbar :icon="icon.mdiAccountSchool">Gestion des cycles</page-toolbar>
    ...
    <v-card-text>
        <table-component :headers="headers" :items="cycles">
            ...
            <template v-slot:item.actions="{ item }">
                <v-icon size="large" color="warning" class="me-2" @click="editItem(item.raw)" :icon="icon.mdiPencil">
                </v-icon>
