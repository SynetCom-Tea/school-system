...
<template color="rgb(119, 109, 110)">
<div style="margin-top: 40px; max-width: 1300px; margin-left: 100px;">
<v-card>
    <page-toolbar :icon="icon.mdiAccountSchool">Nouvel etablissement</page-toolbar>
   
        <v-card-text>
            <v-form>
                <v-row>
                    <v-col md="4">
                        <select-field label="Type" :items="types" item-title="name" item-value="id" :error-messages="errors.type_etablissement_id" v-model="form.type_etablissement_id">
                        </select-field>
                        <text-field name="name" label="Nom etablissement" placeholder="Nom etablissement" :error-messages="errors.name" v-model="form.name"></text-field>
                        <text-field name="adresse" label="Adresse" placeholder="Adresse" v-model="form.adresse"></text-field>
                    </v-col>
                    <v-col md="4">
                        <text-field name="mail" label="Mail" placeholder="Mail" v-model="form.mail"></text-field>
                        <text-field name="pays" label="Pays" placeholder="Pays" v-model="form.pays"></text-field>
                        <text-field name="ville" label="Ville" placeholder="Ville" v-model="form.ville"></text-field>
                    </v-col>
                    <v-col md="4">
                        <text-field name="tel1" label="Téléphone 1" placeholder="Téléphone 1" v-model="form.telephone[0]"></text-field>
                        <text-field name="tel2" label="Téléphone 2" placeholder="Téléphone 2" v-model="form.telephone[1]"></text-field>
                        <text-field name="tel3" label="Téléphone 3" placeholder="Téléphone 3" v-model="form.telephone[2]"></text-field>
                    </v-col>
                </v-row>
                        ...
                        <v-card outlined class="mb-md-2">
                            <v-card-text>
                                <v-row disabled :key="faculte.id" v-for="(faculte, i) in form.facultes">
                                    <v-col md="2">
                                        <text-field label="Code faculté" placeholder="Code faculté" v-model="faculte.code"></text-field>
                                    </v-col>
                                    <v-col md="3">
                                        <text-field label="Libelle faculté" placeholder="Libelle faculté" v-model="faculte.name"></text-field>
                                    </v-col>
                                    <v-col md="6">
