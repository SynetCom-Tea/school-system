...
<AuthenticatedLayout>
    <div style="margin: 10px">
        <Toolbar styleToolbar="background-color: white;" :icon="icons.mdiTimerStarOutline" toolbarTitle="Liste des menus Université"></Toolbar>
        <div style="margin: 10px">
            <h2 class="text-color-secondary">Gestion Université</h2>
        </div>
