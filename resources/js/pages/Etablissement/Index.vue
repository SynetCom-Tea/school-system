      ...
      <v-window v-model="tab">
            ...
            <v-row>
              <v-col :key="i" v-for="(t, i) in getSchools">
                ...
                >
                  <v-img
                    v-if="t.logo"
                    style="object-fit: fill; width: 280px; height: 150px"
                    :src="'../logos/' + t.logo"
                    class="text-white"
                  >
        ...
        <v-window-item value="2">
          ...
          <div class="d-flex align-center justify-space-around pa-4">
            ...
            <span class="mr-4 grey--text">
              <v-pagination
                v-model="institutPage"
                :length="pageCount"
                :total-visible="6"
                :items-per-page="institutsPerPage"
              ></v-pagination>
            </span>
          </div>
        </v-window-item>
