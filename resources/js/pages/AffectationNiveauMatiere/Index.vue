        ...
        data() {
            return {
                ...
                headers: [
                    ...
                    { title: 'Volume Horaire', align: 'center', key: 'volume_horaire' },
...
<template>
    ...
    <Toolbar
      ...
      toolbarTitle="Gestion des matières par niveau"
    ></Toolbar>
                ...
                <v-card>
                    ...
                    <v-card-text>
                                    <v-form ref="form">
                                        ...
                                        <v-row>
                                            <v-col cols="12" md="12">
                                                <text-field type="number" label="Volume_horaire" placeholder="Volume_horaire" v-model="form.volume_horaire" isRequired :rules="rules"></text-field>
                                            
                                            </v-col>
                                        </v-row>
                                        <v-row>
                                            <v-col cols="12" md="12">
                                                <text-field type="number" label="Coefficient" placeholder="Coefficient" v-model="form.coefficient" isRequired :rules="rules"></text-field>
