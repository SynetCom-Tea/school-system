...
<AuthenticatedLayout>
    ...
    <div>
        ...
        <form-wizard color="#004980" step-size="sm" back-button-text="Retour" next-button-text="Suivant" finish-button-text="Enregistrer" @on-complete="sendForm" @on-loading="handleLoading" @on-error="handleError" @on-change="handleChange" @on-validate="validateTabSwitch">
            <!-- Tabs 1 -->

            <tab-content :title="tabTitle1" :before-change="beforeChange">
                <v-card flat v-show="apprenant == null && !loadingWizard">
                    <apprenant-form @formSubmitted="getApprenantForm" :type="type" :apprenant="apprenant" @apprenantFormValid="apprenantFormValid" />
                </v-card>
                <v-card flat v-show="apprenant != null && !loadingWizard">
                    <annee-form @formSubmitted="getAnneeForm" :type="type" :cycles="cycles" :cycleFilieres="cycleFilieres" :niveaux="niveaux" :nbre_limite_eleve="nbre_limite_eleve" :nextIndex="nextIndex" :apprenant="apprenant" :annees="annees" @anneeFormValid="anneeFormValid" />
                </v-card>
            </tab-content>
            ...
            <tab-content :title="tabTitle2" :before-change="beforeChange">
                <v-card flat v-show="apprenant == null && !loadingWizard">
                    <annee-form @formSubmitted="getAnneeForm" :type="type" :cycles="cycles" :cycleFilieres="cycleFilieres" :niveaux="niveaux" :nbre_limite_eleve="nbre_limite_eleve" :nextIndex="nextIndex" :formapprenant="formApprenant" :annees="annees" @anneeFormValid="anneeFormValid" />
                </v-card>
                <v-card flat v-show="apprenant != null && !loadingWizard">
                    <tuteur-form @formSubmitted="getTuteurForm" :type="type" :tuteurShow="0" :niveaux="niveaux" :nextIndex="nextIndex" :tuteurs="tuteurs" @tuteurFormValid="tuteurFormValid" />
                </v-card>
            </tab-content>
            ...
            <tab-content :title="tabTitle3" v-if="apprenant == null" :before-change="beforeChange">
                <v-card flat v-show="!loadingWizard">
                    <tuteur-form @formSubmitted="getTuteurForm" :type="type" :tuteurShow="1" :niveaux="niveaux" :nextIndex="nextIndex" :tuteurs="tuteurs" @tuteurFormValid="tuteurFormValid" />
                </v-card>
                <!-- <v-card flat v-show="apprenant != null && !loadingWizard">
            <document-form
            ...
            <tab-content :title="tabTitle4" v-if="apprenant == null" :before-change="beforeChange">
                <v-card flat v-show="!loadingWizard">
                    <document-form @formSubmitted="getDocumentForm" :type="type" :niveaux="niveaux" :typeDocuments="typeDocuments" @documentFormValid="documentFormValid" />
                </v-card>
            </tab-content>
                                ...
                                this.$swal({
                                    ...
                                    if (result.isConfirmed) {
                                        router.get(route('inscriptions.index', {
                                            section_id: JSON.stringify(this.type)
                                        }))
                                    }
                                })
                            }
