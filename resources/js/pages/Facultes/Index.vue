<script>
    ...
    export default {
        ...
        methods:{
            create() {
                this.dialog = true;
                this.dialog_title = 'Création Faculté'
            },
            editItem(item){
                //console.log('edit',item) 
                this.dialog_title = 'Modifier la Faculté' 
            ...
            deleteItem(item){
                this.$swal({
                    ...
                    if (result.isConfirmed) {
                       ...
                       this.form.delete(route('facultes.destroy', item.id), {
                        onFinish: () => {
            ...
            async submit() {
                ...
                if(!this.form.id && valid) {
                    this.form.post(route('facultes.store'), {
                        onFinish: () => {
                            this.close()
                            ...
                            this.$swal({
                                ...
                                text: 'Faculté créée avec succès!',
                                toast: true,
                                position: 'top-end',
                                showConfirmButton: false,
                                timer: 5000,
                    ...
                    this.form.put(route('facultes.update', this.form.id), {
                        onFinish: () => {
                           this.close()
                            this.$swal({
                                icon: 'success',
                                ...
                                color: '#004980',
                                title: 'Modification',
                                text: 'Faculté modifiée avec succès!',
                                toast: true,
                                position: 'top-end',
                                showConfirmButton: false,
                                timer: 5000,
...
<template>
    ...
    <Toolbar
      ...
      toolbarTitle="Gestion des Facultés"
    ></Toolbar>
        ...
        <v-card-text>
            <Datatable titleDatatable="Liste des facultés" :headers="headers" :items="facultes" :functionOnClickAddButton="create" >
