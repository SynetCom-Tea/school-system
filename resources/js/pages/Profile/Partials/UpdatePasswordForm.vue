...
import { ref } from 'vue';
import { mdiEyeOffOutline, mdiEyeOutline, mdiCircle } from "@mdi/js";
            ...
            <v-row class="mb-3">
              ...
              >
                ...
                <text-field
                  ...
                  :append-inner-icon="isCurrentPasswordVisible ? mdiEyeOffOutline : mdiEyeOutline"
      ...
      variant="tonal">Modifié.</v-alert>
            ...
            <v-row>
              ...
              >
                ...
                <text-field
                  ...
                  :append-inner-icon="isNewPasswordVisible ? mdiEyeOffOutline : mdiEyeOutline"
                  label="New Password"
              ...
              >
                ...
                <text-field
                  ...
                  :append-inner-icon="isConfirmPasswordVisible ? mdiEyeOffOutline : mdiEyeOutline"
          ...
          <v-card-actions class="d-flex flex-wrap gap-4">
            <v-btn
              color="primary"
              variant="elevated"
              @click="updatePassword">Changer</v-btn>
