...
<head>
    ...
    <style>
        ...
        thead {
            ...
            /* entête affichée une seule fois par table (classe) */
        }

        tr {
            page-break-inside: avoid;
            /* empêche qu’un élève soit coupé sur 2 pages */
        }
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="23%">Nom & Prénom</th>
                <th width="10%">Date Naissance</th>
                <th width="8%">Sexe</th>
                <th width="10%">Date Inscription</th>
                <th width="8%">Statut</th>
                <th width="10%">Total Frais</th>
                <th width="10%">Total Payé</th>
                <th width="10%">Restant</th>
            </tr>
        </thead>
        <tbody>
