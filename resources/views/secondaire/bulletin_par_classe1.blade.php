...
<body>
    ...
    <div>
       ...
       <!-- <img style="max-width:50%; height:auto" src="logos/iat-logo.png" alt="Logo de l'entreprise"> -->
        ...
        <!-- titre du bulletin -->
        <div style="background-color: grey; margin-left: 250px; margin-top: 150px; margin-left: auto; margin-right: auto; text-align: center;">
            <b style="font-size: 20px;">BULLETIN DE NOTES SEMESTRIEL</b> 
        </div>
        ...
        <table style="font-size: 13px; margin-top: 10px;">
            ...
            <tr>    
                <td margin-left="2" width="153"  height="20" colspan=3>
