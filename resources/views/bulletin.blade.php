...
<body>
    ...
    <div>
        ...
        <b><i style="font-size: 13px; margin: 5px;">ANNEE SCOLAIRE : 2023-2024</i>&nbsp;&nbsp;</b><br>
                    ...
                    <b><i style="font-size: 13px; margin: 5px;">SECTION : @if($section == '1') Primaire @elseif($section == '2' and $niveau->id <= 10) Collège @else Lycée @endif</i>&nbsp;&nbsp;</b><br>
                    <b><i style="font-size: 13px; margin: 5px;">NIVEAU : {{$niveau->code}}</i>&nbsp;&nbsp;</b><br>
        ...
        <div style="margin-left: 260px; width: 210px; height: 30px; margin-top: 10px;">
            <b style="font-size: 20px;">Classe de : {{$item['nom_classe']}}</b> 
        </div>
        ...
        <div style="margin-top: 10px; position:absolute">
            ...
            <b style="font-size: 13px;">Nom et Prénom de l'élève : {{$item['nom_apprenant']}} {{$item['prenom_apprenant']}}</b> <br>
            <b style="font-size: 13px;">Moyenne obtenue : {{$item['moyenne_details_notes']}} / 20</b>
        </div>
       
        <div style="margin-top: 10px; position:absolute ;margin-left:460px;">
            <b style="font-size: 13px;">Rang : 1 er</b>
        </div>
        ...
        <table style="margin-top: 100px; font-size: 13px;">
            ...
            <tbody>
                ...
                $total = 0;
                @endphp
                @foreach($item['details_notes'] as $line)
                    @php
                        $total = $total + $line['moyenneCoefficiente'];
                    @endphp
                    <tr>
                        <td><b>{{$line['nom_matiere']}}</b></td>
                        <td style="text-align:center;" width="30">{{$line['noteDeClasse']}}</td>
                        <td style="text-align:center;" width="30">{{$line['noteDeComposition']}}</td>
                        <td style="text-align:center;" width="30">{{$line['moyenne']}}</td>
                        <td style="text-align:center;" width="40">{{$line['coefficient']}}</td>
                        <td style="text-align:center;" width="40">{{$line['moyenneCoefficiente']}}</td>
                ...
                <tr>
                    ...
                    <td style="text-align:center" colspan="8">{{$item['moyenne_details_notes']}}</td>
                </tr>
